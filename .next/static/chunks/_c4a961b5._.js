...
function AdminLoginPage() {
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        try {
            ...
            const isAuthorized = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ADMIN_EMAILS"].includes(result.user.email || '');
            if (!isAuthorized) {
                toast({
                    variant: 'destructive',
    ...
    if (isUserLoading || user && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admins$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ADMIN_EMAILS"].includes(user.email || '')) {
...
_s(AdminLoginPage, "RQJBwG6QzcHTOEhzUFrxkSLqH6Y=", false, function() {
    return [
...
//# sourceMappingURL=_c4a961b5._.js.map